...
build: gtk-3.0/gtk.css gnome-shell/gnome-shell.css

gtk-3.0/gtk.css: base16.scss
	sassc $(SASSC_OPT) gtk-3.0/gtk.scss gtk-3.0/gtk.css
	cat gtk-3.0/patches/* >> gtk-3.0/gtk.css

gtk-4.0/gtk.css: base16.scss
	sassc $(SASSC_OPT) gtk-4.0/gtk.scss gtk-4.0/gtk.css
...
system-install: build
	@if [ "$$UID" -eq 0 ]; then \
		...
		cp -r gnome-shell gtk-3.0 /usr/share/themes/FlatWaita-16/; \
	else \
